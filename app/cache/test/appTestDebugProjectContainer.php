...
class appTestDebugProjectContainer extends Container
{
    ...
    {
        return $this->services['annotation_reader'] = new \Doctrine\Common\Annotations\FileCacheReader(new \Doctrine\Common\Annotations\AnnotationReader(), '/home/boyer/hetic/app/cache/test/annotations', true);
    }
    ...
    protected function getAssetic_AssetManagerService()
    {
        ...
        $this->services['assetic.asset_manager'] = $instance = new \Assetic\Factory\LazyAssetManager($this->get('assetic.asset_factory'), array('twig' => new \Assetic\Factory\Loader\CachedFormulaLoader(new \Assetic\Extension\Twig\TwigFormulaLoader($this->get('twig')), new \Assetic\Cache\ConfigCache('/home/boyer/hetic/app/cache/test/assetic/config'), true)));
    ...
    {
        $this->services['assetic.filter.uglifyjs'] = $instance = new \Assetic\Filter\UglifyJsFilter('/usr/bin/uglifyjs', '/usr/bin/node');
    ...
    {
        return $this->services['assetic.filter_manager'] = new \Symfony\Bundle\AsseticBundle\FilterManager($this, array('cssrewrite' => 'assetic.filter.cssrewrite', 'uglifyjs' => 'assetic.filter.uglifyjs', 'coffee' => 'assetic.filter.coffee', 'sass' => 'assetic.filter.sass', 'compass' => 'assetic.filter.compass', 'yui_css' => 'assetic.filter.yui_css'));
    }
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        $c->addEventSubscriber(new \FOS\ElasticaBundle\Doctrine\ORM\Listener($this->get('fos_elastica.object_persister.website.article'), 'Hetic\\SiteBundle\\Entity\\Article', array(0 => 'postPersist', 1 => 'postUpdate', 2 => 'postRemove', 3 => 'preRemove'), 'id', ''));
        $c->addEventSubscriber(new \FOS\ElasticaBundle\Doctrine\ORM\Listener($this->get('fos_elastica.object_persister.website.category'), 'Hetic\\SiteBundle\\Entity\\Category', array(0 => 'postPersist', 1 => 'postUpdate', 2 => 'postRemove', 3 => 'preRemove'), 'id', ''));
        $c->addEventSubscriber(new \FOS\ElasticaBundle\Doctrine\ORM\Listener($this->get('fos_elastica.object_persister.website.tag'), 'Hetic\\SiteBundle\\Entity\\Tag', array(0 => 'postPersist', 1 => 'postUpdate', 2 => 'postRemove', 3 => 'preRemove'), 'id', ''));

        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('dbname' => 'symfony', 'host' => '127.0.0.1', 'port' => NULL, 'user' => 'root', 'password' => 'djscrave', 'charset' => 'UTF8', 'driver' => 'pdo_mysql', 'driverOptions' => array()), $b, $c, array());
    }
     ...
     * This method always returns the same instance of the service.
     *
     * @return EntityManager527a8a2305c46_546a8d27f194334ee012bfe64f629947b07e4919\__CG__\Doctrine\ORM\EntityManager A EntityManager527a8a2305c46_546a8d27f194334ee012bfe64f629947b07e4919\__CG__\Doctrine\ORM\EntityManager instance.
     */
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        require_once '/home/boyer/hetic/app/cache/test/jms_diextra/doctrine/EntityManager_527a8a2305c46.php';

        $a = new \Doctrine\Common\Cache\ArrayCache();
        $a->setNamespace('sf2orm_default_43c7af4339d871192484ab0181e23ab4608daf3c12dd725a4f161fff4441e2c3');

        $b = new \Doctrine\Common\Cache\ArrayCache();
        $b->setNamespace('sf2orm_default_43c7af4339d871192484ab0181e23ab4608daf3c12dd725a4f161fff4441e2c3');

        $c = new \Doctrine\Common\Cache\ArrayCache();
        $c->setNamespace('sf2orm_default_43c7af4339d871192484ab0181e23ab4608daf3c12dd725a4f161fff4441e2c3');
        ...
        $e->setProxyDir('/home/boyer/hetic/app/cache/test/doctrine/orm/Proxies');
        ...
        return $this->services['doctrine.orm.default_entity_manager'] = new \EntityManager527a8a2305c46_546a8d27f194334ee012bfe64f629947b07e4919\__CG__\Doctrine\ORM\EntityManager($f, $this);
    }
    ...
    /**
     * Gets the 'fos_elastica.finder.website.article' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
    ...
    {
        $a = new \FOS\ElasticaBundle\Doctrine\ORM\ElasticaToModelTransformer($this->get('doctrine'), 'Hetic\\SiteBundle\\Entity\\Article', array('hydrate' => true, 'identifier' => 'id', 'ignore_missing' => false));
    ...
    /**
     * Gets the 'fos_elastica.finder.website.category' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
    ...
    {
        $a = new \FOS\ElasticaBundle\Doctrine\ORM\ElasticaToModelTransformer($this->get('doctrine'), 'Hetic\\SiteBundle\\Entity\\Category', array('hydrate' => true, 'identifier' => 'id', 'ignore_missing' => false));
        $a->setPropertyAccessor($this->get('fos_elastica.property_accessor'));
    ...
    /**
     * Gets the 'fos_elastica.finder.website.tag' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
    ...
    {
        $a = new \FOS\ElasticaBundle\Doctrine\ORM\ElasticaToModelTransformer($this->get('doctrine'), 'Hetic\\SiteBundle\\Entity\\Tag', array('hydrate' => true, 'identifier' => 'id', 'ignore_missing' => false));
        $a->setPropertyAccessor($this->get('fos_elastica.property_accessor'));
    ...
    /**
     * Gets the 'fos_elastica.index.website' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return Elastica\Index A Elastica\Index instance.
     */
    ...
    /**
     * Gets the 'fos_elastica.index.website.article' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
    ...
    /**
     * Gets the 'fos_elastica.index.website.category' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
    ...
    /**
     * Gets the 'fos_elastica.index.website.tag' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
    ...
    /**
     * Gets the 'fos_elastica.object_persister.website.article' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
    ...
    /**
     * Gets the 'fos_elastica.object_persister.website.category' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
    ...
    /**
     * Gets the 'fos_elastica.object_persister.website.tag' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
    ...
    /**
     * Gets the 'fos_elastica.provider.website.article' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
    ...
    /**
     * Gets the 'fos_elastica.provider.website.category' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
    ...
    /**
     * Gets the 'fos_elastica.provider.website.tag' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
    ...
    protected function getJmsDiExtra_Metadata_MetadataFactoryService()
    {
        ...
        $instance->setCache(new \Metadata\Cache\FileCache('/home/boyer/hetic/app/cache/test/jms_diextra/metadata'));
    ...
    protected function getJmsSerializerService()
    {
        ...
        $a->setCache(new \Metadata\Cache\FileCache('/home/boyer/hetic/app/cache/test/jms_serializer'));
    ...
    {
        return $this->services['monolog.handler.main'] = new \Monolog\Handler\StreamHandler('/home/boyer/hetic/app/logs/test.log', 100, true);
    }
    ...
    protected function getProfilerService()
    {
        ...
        $this->services['profiler'] = $instance = new \Symfony\Component\HttpKernel\Profiler\Profiler(new \Symfony\Component\HttpKernel\Profiler\FileProfilerStorage('file:/home/boyer/hetic/app/cache/test/profiler', '', '', 86400), $a);
    ...
    protected function getSecurity_Access_DecisionManagerService()
    {
        ...
        $c->setCacheDir('/home/boyer/hetic/app/cache/test/jms_security/expressions');
    ...
    {
        return $this->services['security.firewall'] = new \Symfony\Component\Security\Http\Firewall(new \Symfony\Bundle\SecurityBundle\Security\FirewallMap($this, array('security.firewall.map.context.login' => new \Symfony\Component\HttpFoundation\RequestMatcher('^/demo/secured/login$'), 'security.firewall.map.context.secured_area' => new \Symfony\Component\HttpFoundation\RequestMatcher('^/administration'))), $this->get('debug.event_dispatcher'));
    }
    ...
    protected function getSecurity_Firewall_Map_Context_SecuredAreaService()
    {
        ...
        $l = new \Symfony\Component\Security\Http\Firewall\LogoutListener($b, $k, new \Symfony\Component\Security\Http\Logout\DefaultLogoutSuccessHandler($k, '/'), array('csrf_parameter' => '_csrf_token', 'intention' => 'logout', 'logout_path' => 'site_logout'));
        $l->addHandler(new \Symfony\Component\Security\Http\Logout\SessionLogoutHandler());

        $m = new \Symfony\Component\Security\Http\Authentication\DefaultAuthenticationSuccessHandler($k, array('login_path' => 'site_login', 'always_use_default_target_path' => false, 'default_target_path' => '/', 'target_path_parameter' => '_target_path', 'use_referer' => false));
        $m->setProviderKey('secured_area');

        return $this->services['security.firewall.map.context.secured_area'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallContext(array(0 => new \Symfony\Component\Security\Http\Firewall\ChannelListener($j, new \Symfony\Component\Security\Http\EntryPoint\RetryAuthenticationEntryPoint(80, 443), $a), 1 => new \Symfony\Component\Security\Http\Firewall\ContextListener($b, array(0 => $this->get('security.user.provider.concrete.in_memory')), 'secured_area', $a, $c), 2 => $l, 3 => new \Symfony\Component\Security\Http\Firewall\UsernamePasswordFormAuthenticationListener($b, $f, new \Symfony\Component\Security\Http\Session\SessionAuthenticationStrategy('migrate'), $k, 'secured_area', $m, new \Symfony\Component\Security\Http\Authentication\DefaultAuthenticationFailureHandler($e, $k, array('login_path' => 'site_login', 'failure_path' => NULL, 'failure_forward' => false, 'failure_path_parameter' => '_failure_path'), $a), array('check_path' => 'site_login_check', 'use_forward' => false, 'require_previous_session' => true, 'username_parameter' => '_username', 'password_parameter' => '_password', 'csrf_parameter' => '_csrf_token', 'intention' => 'authenticate', 'post_only' => true), $a, $c), 4 => new \Symfony\Component\Security\Http\Firewall\AccessListener($b, $this->get('security.access.decision_manager'), $j, $f)), new \Symfony\Component\Security\Http\Firewall\ExceptionListener($b, $this->get('security.authentication.trust_resolver'), $k, 'secured_area', new \Symfony\Component\Security\Http\EntryPoint\FormAuthenticationEntryPoint($e, $k, 'site_login', false), NULL, NULL, $a));
    }
    ...
    {
        return $this->services['security.role_hierarchy'] = new \Symfony\Component\Security\Core\Role\RoleHierarchy(array('ROLE_ADMIN' => array(0 => 'ROLE_USER'), 'ROLE_SUPER_ADMIN' => array(0 => 'ROLE_USER', 1 => 'ROLE_ANONYM', 2 => 'ROLE_ADMIN', 3 => 'ROLE_ALLOWED_TO_SWITCH')));
    }
    ...
    {
        return $this->services['security.secure_random'] = new \Symfony\Component\Security\Core\Util\SecureRandom('/home/boyer/hetic/app/cache/test/secure_random.seed', $this->get('monolog.logger.security', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    {
        return $this->services['sensio_distribution.webconfigurator'] = new \Sensio\Bundle\DistributionBundle\Configurator\Configurator('/home/boyer/hetic/app');
    }
    ...
    {
        return $this->services['session.handler'] = new \Symfony\Component\HttpFoundation\Session\Storage\Handler\NativeFileSessionHandler('/home/boyer/hetic/app/cache/test/sessions');
    }
    ...
    {
        return $this->services['session.storage.filesystem'] = new \Symfony\Component\HttpFoundation\Session\Storage\MockFileSessionStorage('/home/boyer/hetic/app/cache/test/sessions', 'MOCKSESSID', $this->get('session.storage.metadata_bag'));
    }
    ...
    protected function getTemplating_Helper_LogoutUrlService()
    {
        ...
        $instance->registerListener('secured_area', 'site_logout', 'logout', '_csrf_token', NULL);
    ...
    {
        return $this->services['translator.default'] = new \Symfony\Bundle\FrameworkBundle\Translation\Translator($this, $this->get('translator.selector'), array('translation.loader.php' => array(0 => 'php'), 'translation.loader.yml' => array(0 => 'yml'), 'translation.loader.xliff' => array(0 => 'xlf', 1 => 'xliff'), 'translation.loader.po' => array(0 => 'po'), 'translation.loader.mo' => array(0 => 'mo'), 'translation.loader.qt' => array(0 => 'ts'), 'translation.loader.csv' => array(0 => 'csv'), 'translation.loader.res' => array(0 => 'res'), 'translation.loader.dat' => array(0 => 'dat'), 'translation.loader.ini' => array(0 => 'ini'), 'translation.loader.json' => array(0 => 'json')), array('cache_dir' => '/home/boyer/hetic/app/cache/test/translations', 'debug' => true));
    }
    ...
    protected function getTwigService()
    {
        ...
        $this->services['twig'] = $instance = new \Twig_Environment($this->get('twig.loader'), array('debug' => true, 'strict_variables' => true, 'exception_controller' => 'twig.controller.exception:showAction', 'autoescape_service' => NULL, 'autoescape_service_method' => NULL, 'cache' => '/home/boyer/hetic/app/cache/test/twig', 'charset' => 'UTF-8', 'paths' => array()));
        ...
        $instance->addExtension(new \Symfony\Bridge\Twig\Extension\FormExtension(new \Symfony\Bridge\Twig\Form\TwigRenderer(new \Symfony\Bridge\Twig\Form\TwigRendererEngine(array(0 => 'form_div_layout.html.twig', 1 => 'HeticSiteBundle:Form:fields.html.twig')), $this->get('form.csrf_provider', ContainerInterface::NULL_ON_INVALID_REFERENCE))));
        $instance->addExtension(new \Twig_Extension_Debug());
        $instance->addExtension(new \Symfony\Bundle\AsseticBundle\Twig\AsseticExtension($this->get('assetic.asset_factory'), $this->get('templating.name_parser'), true, array(), array(0 => 'HeticSiteBundle'), $this->get('assetic.value_supplier.default', ContainerInterface::NULL_ON_INVALID_REFERENCE)));
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath('/home/boyer/hetic/vendor/symfony/symfony/src/Symfony/Bundle/WebProfilerBundle/Resources/views', 'WebProfiler');
        $instance->addPath('/home/boyer/hetic/vendor/sensio/distribution-bundle/Sensio/Bundle/DistributionBundle/Resources/views', 'SensioDistribution');
    ...
    {
        $this->services['assetic.asset_factory'] = $instance = new \Symfony\Bundle\AsseticBundle\Factory\AssetFactory($this->get('kernel'), $this, $this->getParameterBag(), '/home/boyer/hetic/app/../web', true);
    ...
    {
        return $this->services['assetic.cache'] = new \Assetic\Cache\FilesystemCache('/home/boyer/hetic/app/cache/test/assetic/assets');
    }
    ...
    {
        $this->services['security.extra.metadata_factory'] = $instance = new \Metadata\MetadataFactory(new \Metadata\Driver\LazyLoadingDriver($this, 'security.extra.metadata_driver'), new \Metadata\Cache\FileCache('/home/boyer/hetic/app/cache/test/jms_security', true));
    ...
    {
        return $this->services['templating.locator'] = new \Symfony\Bundle\FrameworkBundle\Templating\Loader\TemplateLocator($this->get('file_locator'), '/home/boyer/hetic/app/cache/test');
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.debug' => true,
            'kernel.name' => 'app',
            'kernel.cache_dir' => '/home/boyer/hetic/app/cache/test',
            ...
            'debug.container.dump' => '/home/boyer/hetic/app/cache/test/appTestDebugProjectContainer.xml',
            ...
            'session.save_path' => '/home/boyer/hetic/app/cache/test/sessions',
            ...
            'profiler.storage.dsn' => 'file:/home/boyer/hetic/app/cache/test/profiler',
            ...
            'router.resource' => '/home/boyer/hetic/app/cache/test/assetic/routing.yml',
            ...
            'twig.form.resources' => array(
                ...
                1 => 'HeticSiteBundle:Form:fields.html.twig',
            ),
            ...
            'twig.options' => array(
                ...
                'cache' => '/home/boyer/hetic/app/cache/test/twig',
                'charset' => 'UTF-8',
                'paths' => array(
            ...
            'swiftmailer.spool.default.memory.path' => '/home/boyer/hetic/app/cache/test/swiftmailer/spool/default',
            ...
            'assetic.cache_dir' => '/home/boyer/hetic/app/cache/test/assetic',
            ...
            'doctrine.orm.proxy_dir' => '/home/boyer/hetic/app/cache/test/doctrine/orm/Proxies',
            ...
            'fos_rest.cache_dir' => '/home/boyer/hetic/app/cache/test/fos_rest',
            ...
            'jms_aop.cache_dir' => '/home/boyer/hetic/app/cache/test/jms_aop',
            ...
            'security.extra.cache_dir' => '/home/boyer/hetic/app/cache/test/jms_security',
            ...
            'jms_di_extra.cache_dir' => '/home/boyer/hetic/app/cache/test/jms_diextra',
            'jms_di_extra.disable_grep' => false,
            'jms_di_extra.doctrine_integration' => true,
            'jms_di_extra.cache_warmer.controller_file_blacklist' => array(

            ),
            'jms_di_extra.doctrine_integration.entity_manager.file' => '/home/boyer/hetic/app/cache/test/jms_diextra/doctrine/EntityManager_527a8a2305c46.php',
            'jms_di_extra.doctrine_integration.entity_manager.class' => 'EntityManager527a8a2305c46_546a8d27f194334ee012bfe64f629947b07e4919\\__CG__\\Doctrine\\ORM\\EntityManager',
