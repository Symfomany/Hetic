...
class Produit
{
     ...
     * Add familles
     *
     * @param Hetic\SiteBundle\Entity\Famille $familles
     * @return Produit
     */
    public function addFamille(\Hetic\SiteBundle\Entity\Famille $familles)
    {
     ...
     * @param Hetic\SiteBundle\Entity\Famille $familles
     */
    public function removeFamille(\Hetic\SiteBundle\Entity\Famille $familles)
    {
