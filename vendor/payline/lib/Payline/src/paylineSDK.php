...
class paylineSDK{
	...
	// SWITCHING VAR
	public $NMAX_TENTATIVE = 1;
	public $CALL_TIMEOUT = 15;
	public $RETRY_TIMEOUT = 15;
	public $PRIMARY = true ;
	...
	**/
	...
	// Fonction qui permet l'utilisation de la plateforme HD et qui corrige le bug de formatage des données pour le WS getCards
